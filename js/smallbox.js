...
$.smallBox = function( opciones ){
	...
	var html = "";
		...
		html += '			</div>';
		html += '			<div class="smallBox-pico">';
		html += '			</div>';
		html += '			<div class="smallBox-cajaColor">';
		html += '				<div class="smallBox-colorTexto">';
		html += '					<i class="fas fa-headset"></i> '+ opciones.contenido +'';	
		html += '				</div>';
...
// Funcion de animacion de salida del SmallBox
...
// Funcion de animacion de entrada del SmallBox
...
// Funcion para remover el SmallBox
